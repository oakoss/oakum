...
- Neutral, because a small number of genuinely underivable facts remain, such as whether a library bundles a dependency at build time. Those are named for the mechanism (`resolves_dependencies_at = "build"`), never for the effect.
