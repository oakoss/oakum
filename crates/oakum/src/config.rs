...
pub fn schema_json() -> String {
    ...
    render_json(&schema(), 0, 0, 0, &mut body);
    body.push('\n');
    body
}

/// Prettier's default print width. Arrays that fit stay on one line so the
/// file survives a repository's formatter unchanged, the goal ADR-0031 sets
